$(function()
{
    ...
    var contador = 0;
    var esferasMuestra = [];
    var maximo = 40;///  linea 166 ver--velocidad cantidad de letras entre menos valor le ponga mas letras aparecen
    var cuentaTiempo=0;/// tiempo limite 
    var tiempo =0;
    swal({title:"Bienvenido", text:"Prueba tu Agilidad", imageUrl:"./img/inicio.png"});
    ...
    $("#start").click(function(event)
	{
        ...
        tiempo = setInterval(function(){
                                    ...
                                    if (cuentaTiempo=== 0) {
                                        ...
                                        swal({title : "Limite de tiempo", text : "Su puntuacion Final es:"+puntuacion,imageUrl:"./img/final.jpg"},
                                            function(){
                                                location.reload();
                                            });
    ...
    var render = function()
    {
        ...
        if(contador === maximo)
        {
            ...
            {
                swal({title : "Perdio", text : "Ha perdido",imageUrl:"./img/error.jpg"},
                function(){
                    location.reload();
                 });
            }
		...
		if(event.keyCode >= 97 && event.keyCode <= 122)
		{
            ...
            for(var i = 0; i < esferasMuestra.length; i++)
            {
                if(esferasMuestra[i].numero === letraPresiona)
                {
                    ...
                    {
                        puntuacion++;
                        if (puntuacion % 10  ==  0) // si la puntuacion es multiplo de 10
                            {
                                maximo--; // aumente la cantidad de letras 
                            };
